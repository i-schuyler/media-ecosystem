...
[evidence index](docs/spikes/phase-1/android-platform-proof/README.md) now
record verified partial Samsung-tablet SAF, media-control, and historical
format observations for issues #2, #3, and #5. The amended v1 requirement is
exactly six formats: MP3 V0, MP3 320, FLAC, AAC, Ogg Vorbis, and WAV. A
targeted five-minute screen-off/WAV/export retest and the Windows six-format
matrix remain. Phase 1 is not complete, and no production technology stack
has been selected.
